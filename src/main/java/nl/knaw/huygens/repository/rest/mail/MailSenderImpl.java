...
public class MailSenderImpl implements MailSender {
  ...
  @Inject
  public MailSenderImpl(@Named("mail.host") String host, @Named("mail.port") String port, @Named("mail.from_address") String fromAddress) {
  ...
  /* (non-Javadoc)
   * @see nl.knaw.huygens.repository.mail.MailSender#sendMail(java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
