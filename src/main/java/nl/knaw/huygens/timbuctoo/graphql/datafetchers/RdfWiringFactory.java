...
import nl.knaw.huygens.timbuctoo.graphql.datafetchers.berkeleydb.datafetchers.CollectionDataFetcher;
import nl.knaw.huygens.timbuctoo.graphql.datafetchers.berkeleydb.datafetchers.DynamicRelationDataFetcher;
import nl.knaw.huygens.timbuctoo.graphql.datafetchers.berkeleydb.datafetchers.OldItemsDataFetcher;
import nl.knaw.huygens.timbuctoo.graphql.datafetchers.berkeleydb.datafetchers.QuadStoreLookUpSubjectByUriFetcher;
import nl.knaw.huygens.timbuctoo.graphql.datafetchers.berkeleydb.datafetchers.RelationDataFetcher;
import nl.knaw.huygens.timbuctoo.graphql.datafetchers.berkeleydb.datafetchers.RelationsOfSubjectDataFetcher;
import nl.knaw.huygens.timbuctoo.graphql.datafetchers.berkeleydb.datafetchers.TypedLiteralDataFetcher;
import nl.knaw.huygens.timbuctoo.graphql.datafetchers.berkeleydb.datafetchers.UnionDataFetcher;
...
import nl.knaw.huygens.timbuctoo.graphql.mutations.SetCustomProvenanceMutation;
  ...
  private static class ObjectTypeResolver implements TypeResolver {
    ...
    public GraphQLObjectType getType(TypeResolutionEnvironment environment) {
      ...
      if (object instanceof TypedValue) {
        ...
        if (typeUris.isEmpty()) {
          typeName = prefix + "_" + typeNameStore.makeGraphQlname(RdfConstants.RDFS_RESOURCE);
        } else {
          typeName = null;
          ...
          if (typeName == null) {
            ...
            typeName = prefix + "_" + typeNameStore.makeGraphQlname(
              typeUris.isEmpty() ? RdfConstants.RDFS_RESOURCE : typeUris.iterator().next()
            );
          }
        }
      } else {
