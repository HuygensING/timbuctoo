...
public class GenericResultSetConverterTest {
  ...
  @Test
  public void testConvertWithStringOfSingleField() throws SQLException, InstantiationException, IllegalAccessException, NoSuchMethodException,
    ...
    GenericResultSetConverter<DocumentExtensionWithStringField> instance = new GenericResultSetConverter<DocumentExtensionWithStringField>(mapping,
                                                                                                                                           type);
  ...
  @Test
  public void testConvertWithStringOfMultipleField() throws InstantiationException, IllegalAccessException, SQLException, NoSuchMethodException,
      SecurityException, IllegalArgumentException, InvocationTargetException {
    Map<String, List<String>> mapping = new HashMap<String, List<String>>();
  ...
  @Test
  public void testConvertWithDatable() throws InstantiationException, IllegalAccessException, SQLException, NoSuchMethodException, SecurityException,
    ...
    GenericResultSetConverter<DocumentExtensionWithDatableField> instance = new GenericResultSetConverter<DocumentExtensionWithDatableField>(mapping,
                                                                                                                                             type);
  ...
  @Test
  public void testConvertWithNoneMappedFields() throws InstantiationException, IllegalAccessException, SQLException, NoSuchMethodException,
      SecurityException, IllegalArgumentException, InvocationTargetException {
    Map<String, List<String>> mapping = new HashMap<String, List<String>>();
  ...
  @Test
  public void testConvertWithExtendedMappings() throws InstantiationException, IllegalAccessException, SQLException, NoSuchMethodException,
      SecurityException, IllegalArgumentException, InvocationTargetException {
    Map<String, List<String>> mapping = new HashMap<String, List<String>>();
    mapping.put("test", Arrays.asList(new String[] { "test" }));
  ...
  @Test()
  public void testConvertWithFieldsNotInResultSet() throws InstantiationException, IllegalAccessException, SQLException, NoSuchMethodException,
      SecurityException, IllegalArgumentException, InvocationTargetException {
    Map<String, List<String>> mapping = new HashMap<String, List<String>>();
  ...
  @Test
  public void testConvertSubclass() throws SQLException, InstantiationException, IllegalAccessException, NoSuchMethodException,
      SecurityException, IllegalArgumentException, InvocationTargetException {
    Map<String, List<String>> mapping = new HashMap<String, List<String>>();
    mapping.put("test", Arrays.asList(new String[] { "test" }));
