...
public class NewGenerator extends JsonGeneratorDelegate {
  ...
  public NewGenerator(JsonGenerator d) {
    super(d);
  ...
  public void writeStartArray() throws IOException, JsonGenerationException {
    if (levels.isEmpty()) {
      writeRaw("<table>\n");
    } else if (NestingLevel.ARRAY.equals(levels.peek())) {
      writeRaw("<td>");
    } else {
      writeRaw("<td><table>\n");
    }
