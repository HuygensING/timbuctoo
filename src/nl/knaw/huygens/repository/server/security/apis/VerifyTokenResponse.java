 ...
 * the token.
 * Copied from org.surfnet.oaaas.model, that model cannot be used,
 * because it uses an older version of jackson, that is not compatible. This is due 
 * to the name change of of the jackson package from <code>org.codehaus</code> to 
 * <code>com.fasterxml</code>. 
 * 
 * The problem was basically the deserialization of the <code>expiresIn</code>-property,
 * the annotation @JsonProperty was ignored.
 */
