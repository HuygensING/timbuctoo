...
If you simply want to add triples to the dataset you should append a new file with the new triples to the resource list.
If you want to remove triples from the dataset you should append a new file in the nquads-ud format (see below)
