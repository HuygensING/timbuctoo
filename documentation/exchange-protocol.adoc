...
The filetypes that we can currently import are, in order of decreasing priority (i.e. if there is a dataset.nq and dataset.rdf
the dataset.nq file gets priority and is read), as follows:
