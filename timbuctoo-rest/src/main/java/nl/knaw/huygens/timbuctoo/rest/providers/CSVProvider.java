...
public class CSVProvider implements MessageBodyWriter<RelationSearchResultDTO> {
  ...
  @Override
  public void writeTo(RelationSearchResultDTO doc, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, Object> httpHeaders, OutputStream out) throws IOException {
    write(out, "id;name\n");
    write(out, "PERS0001;Huygens, Constantijn\n");
    write(out, "PERS0002;Huygens, Christiaan\n");
  }
