...
public class UserResourceTest extends WebServiceTestSetup {
  ...
  public void testGetAllUsers() {
    ...
    when(jsonFileHandler.getSystemEntities(User.class)).thenReturn(iterator);
  ...
  public void testGetUserAsAdmin() {
    ...
    when(jsonFileHandler.getEntity(User.class, USER_ID)).thenReturn(expected);
  ...
  public void testGetUserNotFound() {
    ...
    when(jsonFileHandler.getEntity(User.class, USER_ID)).thenReturn(null);
  ...
  public void testGetMyUserDataAsNewUser() throws Exception {
    ...
    User user = new User();
    user.setId(USER_ID);
    when(jsonFileHandler.findEntity(User.class, user)).thenReturn(user);
    ...
    when(jsonFileHandler.findEntity(VREAuthorization.class, adminExample)).thenReturn(adminAuth);
    when(jsonFileHandler.getEntity(User.class, adminId)).thenReturn(admin);
  ...
  public void testPutUser() {
    ...
    when(jsonFileHandler.getEntity(User.class, USER_ID)).thenReturn(original);
  ...
  public void testPutUserUserNotFound() throws Exception {
    ...
    }).when(jsonFileHandler).updateSystemEntity(any(Class.class), any(User.class));
  ...
  public void testGetVREAuthorizationAsAdmin() {
    ...
    when(jsonFileHandler.findEntity(VREAuthorization.class, example)).thenReturn(expected);
  ...
  public void testGetVREAuthorizationNotFound() {
    ...
    VREAuthorization example = new VREAuthorization(VRE_ID, USER_ID);
    when(jsonFileHandler.findEntity(VREAuthorization.class, example)).thenReturn(null);
  ...
  public void testPostVREAuthorizationAsAdmin() throws Exception {
    ...
    verify(jsonFileHandler).addSystemEntity(VREAuthorization.class, authorization);
  }
  ...
  public void testPostVREAuthorizationAsUser() throws Exception {
    ...
    assertEquals(Status.FORBIDDEN, response.getClientResponseStatus());
    verify(jsonFileHandler, never()).addSystemEntity(VREAuthorization.class, authorization);
  }
  ...
  public void testPutVREAuthorizationAsAdmin() throws Exception {
    ...
    VREAuthorization example = new VREAuthorization(VRE_ID, USER_ID);
    VREAuthorization authorization = new VREAuthorization(VRE_ID, USER_ID, USER_ROLE);
    when(jsonFileHandler.findEntity(VREAuthorization.class, example)).thenReturn(authorization);
    ...
    assertEquals(Status.NO_CONTENT, response.getClientResponseStatus());
    verify(jsonFileHandler).updateSystemEntity(VREAuthorization.class, authorization);
  }
  ...
  public void testPutVREAuthorizationAsUser() throws Exception {
    ...
    assertEquals(Status.FORBIDDEN, response.getClientResponseStatus());
    verify(jsonFileHandler, never()).updateSystemEntity(VREAuthorization.class, authorization);
  }
  ...
  public void testDeleteVREAuthorizationAsAdmin() throws Exception {
    ...
    assertEquals(Status.NO_CONTENT, response.getClientResponseStatus());
    verify(jsonFileHandler).deleteSystemEntity(authorization);
  }
  ...
  public void testDeleteAuthorizationAsUser() throws Exception {
    ...
    assertEquals(Status.FORBIDDEN, response.getClientResponseStatus());
    verify(jsonFileHandler, never()).deleteSystemEntity(any(VREAuthorization.class));
  }
