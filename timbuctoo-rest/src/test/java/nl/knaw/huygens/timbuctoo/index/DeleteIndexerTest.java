...
public class DeleteIndexerTest {
  ...
  public void setUp() throws Exception {
    ...
    instance = new DeleteIndexer(repository, indexManager);
  }
  ...
  @Test
  public void executeForCallsDeleteEntityForEachEntityFoundByTheRepository() throws Exception {
    // action
    instance.executeFor(IndexRequest.forType(TYPE));

    // verify
    verify(indexManager).deleteEntity(TYPE, ID_1);
    verify(indexManager).deleteEntity(TYPE, ID_2);
  }
  ...
  public void executeForSetsTheIndexRequestStatusToIN_PROGRESSWhenStartingAndToDONEWhenFinished() throws Exception {
    ...
    inOrder.verify(indexManager).deleteEntity(TYPE, ID_1);
    inOrder.verify(indexManager).deleteEntity(TYPE, ID_2);
  ...
  public void executeForThrowsAnIndexExceptionWhenTheIndexManagerDoes() throws Exception {
    // setup
    doThrow(new IndexException()).when(indexManager).deleteEntity(TYPE, ID_1);
