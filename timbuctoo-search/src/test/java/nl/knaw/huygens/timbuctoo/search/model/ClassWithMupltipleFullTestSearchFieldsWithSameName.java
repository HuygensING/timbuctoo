...
public class ClassWithMupltipleFullTestSearchFieldsWithSameName extends DomainEntity {
  ...
  @IndexAnnotation(fieldName = "dynamic_t_simple", isFaceted = true, title = "Simple1")
