...
public class SimpleRelationshipConverterTest {
  ...
  private SimpleRelationshipConverter<Relation> instance;
  ...
  public void setUp() {
    ...
    instance = new SimpleRelationshipConverter<Relation>(FIELD_TO_IGNORE);
