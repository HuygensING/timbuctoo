...
public class ExtendableVertexConverterTest extends AbstractElementConverterTest{
  ...
  protected <T extends Entity> ExtendableVertexConverter<T> createInstance(Class<T> type) {
