...
public class RelationTypesTest {
  ...
  public void testGetByIdWhenExceptionOccurs() throws Exception {
    when(storageMock.getEntityOrDefaultVariation(RelationType.class, ID)).thenThrow(new StorageException());

    assertNull(instance.getById(ID, false));
    verify(storageMock).getEntityOrDefaultVariation(RelationType.class, ID);
  }

  @Test
  public void testGetByIdWhenItemIsUnknown() throws Exception {
    when(storageMock.getEntityOrDefaultVariation(RelationType.class, ID)).thenReturn(null);
  ...
  public void testGetByIdWhenItemIsNotInCache() throws Exception {
    ...
    when(storageMock.getEntityOrDefaultVariation(RelationType.class, ID)).thenReturn(type);
  ...
  public void testGetByIdWhenItemIsInCache() throws Exception {
    ...
    assertEquals(type, instance.getById(ID, false));
    assertEquals(type, instance.getById(ID, false));
    verify(storageMock, times(1)).getEntityOrDefaultVariation(RelationType.class, ID);
  }
