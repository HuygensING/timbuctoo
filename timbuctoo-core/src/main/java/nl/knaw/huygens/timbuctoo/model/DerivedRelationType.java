...
/**
 * Defines a derived relation type in terms of two other relation type names.
 * Schematically:
 * primary relation: node1 --> node2
...
public class DerivedRelationType {
  ...
  public String getSecundaryTypeName() {
    return secundaryTypeName;
  }
