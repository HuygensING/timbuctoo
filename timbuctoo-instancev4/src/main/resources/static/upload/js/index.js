      ...
      dispatch(function (dispatch, getState) {
        ...
        req.onload = function () {
          if (req.status > 400) {
            ...
            dispatch(function (dispatch, getState) {
              var state = getState();
              if (state.mappings.publishErrors === 0) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        { userId: userId, caption: "My datasets", vres: vres, searchGuiUrl: searchGuiUrl },
        uploadButton
      )
    )
  );
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      Object.keys(vres).map(function (vre) {
        return _react2.default.createElement(_datasetCard2.default, { key: vre, searchGuiUrl: searchGuiUrl, userId: userId, vreId: vres[vre].name, caption: vres[vre].name.replace(/^[a-z0-9]+_/, "") });
      })
    )
  );
};
...
exports.default = function () {
	...
	var _ret = function () {
		switch (action.type) {
			case "START_UPLOAD":
				return {
					v: _extends({}, initialState, { uploadStatus: "transfering file" })
				};
			case "UPLOAD_STATUS_UPDATE":
				if (action.data) {
					...
					uploadStatus = "processing " + currentSheet + " (row " + rows + (failures > 0 ? ", " + failures + " failures" : "") + ")";
...
exports.default = function () {
  ...
  switch (action.type) {
    ...
    case "PUBLISH_STATUS_UPDATE":
      if (action.data) {
        var publishErrors = state.publishErrors || 0;
        var tripleCount = state.tripleCount || 0;
        if (action.data.substr(0, "failure: ".length) === "failure: ") {
          publishErrors++;
        }
        tripleCount++;
        var publishStatus = "processing triple " + tripleCount + (publishErrors > 0 ? " (" + publishErrors + " failures)" : "");
        return _extends({}, state, {
          publishErrors: publishErrors,
