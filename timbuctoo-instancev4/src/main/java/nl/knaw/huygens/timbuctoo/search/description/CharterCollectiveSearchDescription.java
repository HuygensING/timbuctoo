...
public class CharterCollectiveSearchDescription extends AbstractSearchDescription implements SearchDescription {
  ...
  private final String type = "chartercollective";
  ...
  public CharterCollectiveSearchDescription(PropertyDescriptorFactory propertyDescriptorFactory,
  ...
  private PropertyDescriptor createDisplayNameDescriptor() {
    PropertyDescriptor descriptor = propertyDescriptorFactory.getLocal("chartercollective_name", String.class);
    return descriptor;
  }
  ...
  private List<FacetDescription> createFacetDescriptions(FacetDescriptionFactory facetDescriptionFactory) {
    return Lists.newArrayList(facetDescriptionFactory.createListFacetDescription("dynamic_s_type", CollectiveType.class,
        "chartercollective_type"));
  }

  private ArrayList<FullTextSearchDescription> createFullTextSearchDescriptions() {
    return Lists.newArrayList(createLocalSimpleFullTextSearchDescription("dynamic_t_name", "chartercollective_name"));
  }
