...
- http://localhost:8080/v2.1/remote/rs/discover/listgraphs?url=http%3A%2F%2Fyour%2Frdf%2Fserver - list the graph iri's at the remote site
- http://localhost:8080/v2.1/remote/rs/discover/listsets?url=http%3A%2F%2Fyour%2Frdf%2Fserver - same as previous, agnostic to base64-convention
