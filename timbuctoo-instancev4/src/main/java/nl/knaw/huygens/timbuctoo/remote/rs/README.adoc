...
The http://www.openarchives.org/rs/1.0/resourcesync[resource sync specification] describes how various documents interlink in order to describe a set of resources and where the entrypoints should be placed.
...
- http://localhost:8080/v2.1/remote/rs/discover/listgraphs/http%3A%2F%2Fyour%2Frdf%2Fserver - list the graph iri's at the remote site
- http://localhost:8080/v2.1/remote/rs/discover/listsets/http%3A%2F%2Fyour%2Frdf%2Fserver - same as previous, agnostic to base64-convention
- http://localhost:8080/v2.1/remote/rs/discover/framework/http%3A%2F%2Fyour%2Frdf%2Fserver - flat representation of the ResourceSync Framework documents
- http://localhost:8080/v2.1/remote/rs/discover/tree/http%3A%2F%2Fyour%2Frdf%2Fserver - hierarchical representation of the ResourceSync Framework documents
...
- todo:feature[choose a format for describing the datasets and link it using `describedby` (something like dcat or VOID ) and make the discovery use that information for presenting the data to the user.]
