...
public class DomainCrudAutocompleteV2_1EndPoint {

  public static URI makeUrl(String collectionName, String token) {
    return UriBuilder.fromResource(DomainCrudAutocompleteV2_1EndPoint.class)
  ...
  public DomainCrudAutocompleteV2_1EndPoint(TinkerpopJsonCrudService crudService) {
