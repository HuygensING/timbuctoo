...
public class CollectionMapperTest {
  ...
  //   instance.addToCollection(graph.addVertex(), new CollectionDescription("test", VRE_NAME), collection.getVertex());
  //
  ...
  //                   .hasLabel(Collection.DATABASE_LABEL).out(Collection.HAS_ENTITY_NODE_RELATION_NAME).count()
  // .next(),
  //     is(1L));
  // }
  //
  ...
  //
  //   instance.addToCollection(vertexToAdd, new CollectionDescription("test", VRE_NAME), collection.getVertex());
  //
  //   assertThat(graph.traversal().V()
  ...
  //   instance.addToCollection(graph.addVertex(), new CollectionDescription("test", VRE_NAME), collection.getVertex());
  //
  //   assertThat(graph.traversal().V().hasLabel(Collection.DATABASE_LABEL).out(Collection
  ...
  //   instance.addToCollection(vertex, new CollectionDescription("test", VRE_NAME), collection.getVertex());
  //   instance.addToCollection(vertex, new CollectionDescription("test", VRE_NAME), collection.getVertex());
  //
  //   assertThat(graph.traversal().V().hasLabel(Collection.DATABASE_LABEL).out(Collection
  // .HAS_ENTITY_NODE_RELATION_NAME)
  ...
  //   Vertex vertex = graph.addVertex();
  //   instance.addToCollection(vertex, new CollectionDescription("unknown", VRE_NAME), collection.getVertex());
  //
  //
  ...
  //
  //   instance.addToCollection(vertex, new CollectionDescription("test", VRE_NAME), collection.getVertex());
  //   instance.addToCollection(vertex, new CollectionDescription("other", VRE_NAME), collection.getVertex());
  //
  ...
  //   Vertex vertex = graph.addVertex();
  //
  //   instance.addToCollection(vertex, CollectionDescription.getDefault(VRE_NAME), collection.getVertex());
  //
  //   assertThat(graph.traversal().V(vertex.id())
  ...
  //
  //   instance.addToCollection(vertex, collectionDescription, collection.getVertex());
  //   instance.addToCollection(vertex, collectionDescription, collection.getVertex());
  //   instance.addToCollection(vertex, collectionDescription, collection.getVertex());
  //
  //   assertThat(graph.traversal().V(vertex.id())
