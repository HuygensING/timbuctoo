...
public class MakePublicDataFetcherTest {
  @Test
  public void getReturnsDataSetMetadata() throws Exception {
    ...
    given(dataSetRepository.publishDataSet("testUserId","testOwnerId","testDataSetId"))
      .willReturn(dataSetMetaData);
