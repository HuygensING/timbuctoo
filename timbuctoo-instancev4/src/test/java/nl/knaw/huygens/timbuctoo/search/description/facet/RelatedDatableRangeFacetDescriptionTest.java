...
public class RelatedDatableRangeFacetDescriptionTest {
  ...
  public void getFacetReturnsRangeOptionWithDefaultValuesWhenTheStoredDatabaseIsNotValid() {
    Graph graph = newGraph()
            .withVertex("target", v -> v.withTimId("id1").withProperty(PROPERTY_NAME, "invalidDatable"))
            .withVertex("source", v -> v.withTimId("id2").withOutgoingRelation(RELATION, "target"))
            .build();
  ...
  public void getFacetReturnsTheUpperAndLowerLimitInYearMonthDayFormat() {
    Graph graph = newGraph()
            .withVertex("target", v -> v.withProperty(PROPERTY_NAME, asSerializedDatable("2015-01")))
            .withVertex("source", v -> v.withOutgoingRelation(RELATION, "target"))
            .build();
  ...
  public void getFacetReturnsLowestLowerLimitAndTheHighestUpperLimit() {
    Graph graph = newGraph()
            .withVertex("target1", v -> v.withProperty(PROPERTY_NAME, asSerializedDatable("2015-01")))
            .withVertex("target2", v -> v.withProperty(PROPERTY_NAME, asSerializedDatable("0015-01")))
            .withVertex("target3", v -> v.withProperty(PROPERTY_NAME, asSerializedDatable("0190-01")))
            .withVertex("source1", v -> v.withOutgoingRelation(RELATION, "target1"))
            .withVertex("source2", v -> v.withOutgoingRelation(RELATION, "target2"))
            .withVertex("source3", v -> v.withOutgoingRelation(RELATION, "target3"))
            .build();
